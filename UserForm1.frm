...
Private Sub BTAlterarRegistro_Click()
    ...
    ' Verifica se o ID inserido � um n�mero
    If Not IsNumeric(Me.TextBoxIDP.Value) Then
        MsgBox "O ID deve ser um n�mero!"
        Exit Sub
    End If
    
    valor = CLng(Me.TextBoxIDP.Value)
    
    ' Confirma se o usu�rio deseja alterar o cadastro
...
Private Sub BTBuscaCEP_Click()
    ...
    ' Verifica se o campo de CEP n�o est� vazio
    If Me.TextBoxCEP.Value = "" Then
        MsgBox "Por favor, insira um CEP v�lido.", vbExclamation
        Exit Sub
    End If
    
    CEP = Me.TextBoxCEP.Value
    
    ' Chama a fun��o de busca do CEP
    ...
    If Rua = "" And Bairro = "" And Uf = "" And Cidade = "" Then
        MsgBox "CEP n�o encontrado. Verifique o CEP informado.", vbExclamation
        Exit Sub
    End If
    
    ' Atualiza os campos do formul�rio com os valores obtidos
...
End Sub
    ...
    ' Verificar se o TextBoxIDP est� vazio
    If Me.TextBoxIDP.Value = "" Then
        MsgBox "Selecione um Cadastro antes de prosseguir com a exclus�o!"
        Exit Sub
    End If
    ...
    If resposta = vbYes Then
        With Me.ListBox_2
            registroEncontrado = False ' Inicializa como n�o encontrado
            
            ' Percorrer os itens da ListBox de tr�s para frente
            For i = .ListCount - 1 To 0 Step -1
                If .Selected(i) Then
                    ...
                    If Not linha Is Nothing Then
                        ...
                        MsgBox "Registro exclu�do com sucesso!"
                        Exit For ' Sai do loop ap�s excluir o registro
                    End If
                End If
            Next i
            
            ' Exibe uma mensagem caso o registro n�o tenha sido encontrado
            If Not registroEncontrado Then
                MsgBox "Registro n�o encontrado na planilha!"
            End If
        End With
    End If
...
Private Sub BTInserirNovol_Click()
    ...
    ' Definir o pr�ximo ID automaticamente com base no maior valor da coluna A
...
Else
    MsgBox "ID n�o encontrado. Verifique o ID inserido.", vbExclamation, "Erro"
    Exit Sub
End If
...
"Casca Md ou Pq", "Fragmentos de Casca", "Pau/Pedra/Torr�o Gd", "Pau/Pedra/Torr�o Md", "Pau/Pedra/Torr�o Pq")
...
If i > UBound(colunasDefeitos) Then
    MsgBox "Defeito n�o reconhecido. Verifique o valor selecionado.", vbExclamation, "Erro"
    Exit Sub
End If
...
Private Sub BTSalvarNovo_Click()
    ...
    If Me.TextBoxIDP.Value <> Me.TextBoxIDAmostra.Value Then
        ...
        MsgBox "Os ID n�o correspondem!", vbExclamation
    ...
    MsgBox "Cadastro Conclu�do com Sucesso!"
